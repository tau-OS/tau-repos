...
# i don't know how to fix the lint error sorry
...
for file in %{_sourcedir}/tauOS*repo ; do
...
install -m 644 %{_sourcedir}/tau.conf %{buildroot}%{_sysconfdir}/ostree/remotes.d/
